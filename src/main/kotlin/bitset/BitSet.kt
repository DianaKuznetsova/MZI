...
class BitSet(size: Int = ELEMENT_SIZE) {
    ...
    /** True if this bitset.BitSet contains no bits set to true. */
    val isEmpty: Boolean
    ...
    /** Sets all bits in the bitset.BitSet to `false`. */
    fun clear() {
    ...
    /** Performs a logical and operation over corresponding bits of this and [another] BitSets. The result is saved in this bitset.BitSet. */
    fun and(another: BitSet) = doOperation(another, Long::and)

    /** Performs a logical or operation over corresponding bits of this and [another] BitSets. The result is saved in this bitset.BitSet. */
    fun or(another: BitSet) = doOperation(another, Long::or)

    /** Performs a logical xor operation over corresponding bits of this and [another] BitSets. The result is saved in this bitset.BitSet. */
    fun xor(another: BitSet) = doOperation(another, Long::xor)

    /** Performs a logical and + not operations over corresponding bits of this and [another] BitSets. The result is saved in this bitset.BitSet. */
    ...
    /** Returns true if the specified bitset.BitSet has any bits set to true that are also set to true in this bitset.BitSet. */
